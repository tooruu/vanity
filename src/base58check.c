...
void base58(uint8_t s[], size_t s_size, char* out, size_t out_size) {
    int c, i, n;
...
void base58check(const uint8_t* data, size_t data_len, char* out, size_t out_size) {
    ...
    base58(buffer, data_len + 4, out, out_size);
}
